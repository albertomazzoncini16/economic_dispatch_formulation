...
from src.utils.objects_utils.abstract_object_subclasses import get_object_class_name, assert_abstract_object_subclass
...
class DataManager:
    ...
    def get_object_class_instances(self,
                                   object_class: type[AbstractObject]
                                   ) -> Dict[str, AbstractObject]:
        assert_abstract_object_subclass(object_class)
        object_class_name = get_object_class_name(object_class)
        return self.objects_database.get(object_class_name, {})
